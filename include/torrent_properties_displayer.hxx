...
public:
         ...
         void update_file_info(const QString & file_name,std::int64_t dled_byte_cnt) noexcept;
private:
         void setup_tab_widget() noexcept;
         void setup_general_info_widget(const bencode::Metadata & torrent_metadata) noexcept;
         void setup_file_info_widget(const bencode::Metadata & torrent_metadata) noexcept;
         ///
         ...
         QHash<QString,std::int32_t> file_idxes_;
};